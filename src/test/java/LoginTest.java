...
public class LoginTest extends BaseTest {
    ...
    public void checkLogin() {
        ...
        driver.findElement(By.cssSelector("[id='user-name']")).sendKeys("no_problem_user");
        driver.findElement(By.cssSelector("[id='user-name']")).sendKeys(Keys.CONTROL + "A");
        driver.findElement(By.cssSelector("[id='user-name']")).sendKeys(Keys.BACK_SPACE);
        driver.findElement(By.cssSelector("[id='user-name']")).sendKeys("problem_user");
